    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
                ...
                _modelBuilder.Entity<User>().HasData(
                    new { Id = 1, UserName = "viniciusgaio", Password = "123456", FullName = "Vinicius Gaio Moncorvo", RefreshToken = "h9lzVOoLlBoTbcQrh/e16/aIj+4p6C67lLdDbBRMsjE=", RefreshTokenExpiryTime = new DateTime(2022, 08, 01) }
                    );
